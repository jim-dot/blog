...
class User extends Base
{
    ...
    public function adminList(){
        ...
        $this->view->assign('keywords','博客后台系统');
    ...
    public function adminAdd(){
        ...
        $this->view->assign('keywords','myblog.com');
        $this->view->assign('desc','博客后台系统系统');
    ...
    public function addUser(Request $request){
        ...
        //有逻辑错误，有时间再来修复
        $rule=[
            'name|用户名'=>"require|min:2|max:10",
            'password|密码'=>"require|min:6|max:50",
            'email|邮箱'=>"require|email"
        ];

        $req=$this->validate($data,$rule);
    ...
    public function editUser(Request $request){
        ...
        $dataList['password']=md5($data['password']);
        ...
        //设置更新条件      
        $map['id'] =$id;
        $result=UserModel::update($dataList,$map);
